...
#define PLAYER_AVATAR_GFX_MALE_NORMAL     (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL     : OBJ_EVENT_GFX_BRENDAN_NORMAL)
#define PLAYER_AVATAR_GFX_MALE_MACH_BIKE  (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL       : OBJ_EVENT_GFX_BRENDAN_MACH_BIKE)
#define PLAYER_AVATAR_GFX_MALE_ACRO_BIKE  (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL       : OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE)
#define PLAYER_AVATAR_GFX_MALE_SURFING    (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL       : OBJ_EVENT_GFX_BRENDAN_SURFING)
#define PLAYER_AVATAR_GFX_MALE_UNDERWATER (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL       : OBJ_EVENT_GFX_BRENDAN_UNDERWATER)
#define PLAYER_AVATAR_GFX_MALE_FIELD_MOVE (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL : OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE)
#define PLAYER_AVATAR_GFX_MALE_FISHING    (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL       : OBJ_EVENT_GFX_BRENDAN_FISHING)
#define PLAYER_AVATAR_GFX_MALE_WATERING   (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL : OBJ_EVENT_GFX_BRENDAN_WATERING)
#define PLAYER_AVATAR_GFX_MALE_VSSEEKER   (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL  : OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE)
#define PLAYER_AVATAR_GFX_FEMALE_NORMAL     (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL     : OBJ_EVENT_GFX_MAY_NORMAL)
#define PLAYER_AVATAR_GFX_FEMALE_MACH_BIKE  (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL       : OBJ_EVENT_GFX_MAY_MACH_BIKE)
#define PLAYER_AVATAR_GFX_FEMALE_ACRO_BIKE  (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL       : OBJ_EVENT_GFX_MAY_ACRO_BIKE)
#define PLAYER_AVATAR_GFX_FEMALE_SURFING    (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL       : OBJ_EVENT_GFX_MAY_SURFING)
#define PLAYER_AVATAR_GFX_FEMALE_UNDERWATER (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL       : OBJ_EVENT_GFX_MAY_UNDERWATER)
#define PLAYER_AVATAR_GFX_FEMALE_FIELD_MOVE (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL : OBJ_EVENT_GFX_MAY_FIELD_MOVE)
#define PLAYER_AVATAR_GFX_FEMALE_FISHING    (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL       : OBJ_EVENT_GFX_MAY_FISHING)
#define PLAYER_AVATAR_GFX_FEMALE_WATERING   (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL : OBJ_EVENT_GFX_MAY_WATERING)
#define PLAYER_AVATAR_GFX_FEMALE_VSSEEKER   (IS_HNS ? OBJ_EVENT_GFX_RED_NORMAL  : OBJ_EVENT_GFX_MAY_FIELD_MOVE)
